...
SPECS: dict[str, ModelSpec] = {
    ...
    # 2026-06-02: Stationary OFI fix — 90-day percentile rank variants (V141).
    # All prior OFI specs (regime_eth_ofi_v1, directional_*_ofi_*_v1) showed
    # adversarial_auc ≈ 1.0 because ofi_ratio/ofi_zscore_24h/cvd_proxy_zscore_24h
    # have severe multi-year distributional drift. V141 adds ofi_ratio_pctrank_90d
    # and cvd_proxy_pctrank_90d — rolling percentile rank forces [0,1] uniform
    # output regardless of epoch. Old OFI features explicitly excluded below.
    "directional_btc_ofi_1h_v2": ModelSpec(
        name="directional_btc_ofi_1h_v2",
        purpose="directional",
        label_feature="label_long_win_tb_1h_v1",
        label_version=1,
        objective="binary",
        ...
        derived_features=(),
        extra_excluded_features=(
            # Explicitly exclude non-stationary OFI predecessors
            "ofi_ratio",
            "ofi_zscore_24h",
            "ofi_momentum_8h",
    ...
    "directional_eth_ofi_1h_v2": ModelSpec(
        name="directional_eth_ofi_1h_v2",
        purpose="directional",
        label_feature="label_long_win_tb_eth_1h_v1",
        label_version=1,
        objective="binary",
    ...
    "directional_eth_ofi_4h_v2": ModelSpec(
        name="directional_eth_ofi_4h_v2",
        purpose="directional",
        label_feature="label_long_win_tb_eth_4h_v1",
        label_version=1,
        objective="binary",
